...
@RestController
@RequestMapping("api/v1/admin/chiffrecles")
@RequiredArgsConstructor
public class ChiffreCleAdminLoadController extends BaseController<ChiffreCle> {
        ...
        @GetMapping("")
        @PreAuthorize("hasAuthority('chiffre_cle:list')")
        ...
        @GetMapping("/{id}")
        @PreAuthorize("hasAuthority('chiffre_cle:read')")
