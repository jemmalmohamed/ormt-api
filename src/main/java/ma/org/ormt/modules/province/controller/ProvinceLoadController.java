package ma.org.ormt.modules.province.controller;
...
import ma.org.ormt.modules.province.dto.ProvinceDtoMapper;
import ma.org.ormt.modules.province.dto.detail.ProvinceDetailDto;
import ma.org.ormt.modules.province.dto.detail.ProvinceDetailMapper;
import ma.org.ormt.modules.province.service.ProvinceService;

@RestController
@RequestMapping("api/v1/provinces")
@RequiredArgsConstructor
public class ProvinceLoadController extends BaseController<Province> {

        private static final String ENTITY_NAME = "province";

        private final ProvinceService provinceService;
        private final ProvinceDtoMapper provinceDtoMapper;
        private final ProvinceDetailMapper provinceDetailMapper;
        ...
        public ResponseEntity<RestResponse<List<ProvinceDto>>> getProvinces(
                ...
                Page<Province> provincePage = provinceService.getEntityList(requestParams);

                List<ProvinceDto> dtos = provinceDtoMapper.mapToDto(provincePage.getContent());

                QueryParams queryParams = adjustQueryParamsForAllRecords(requestParams, provincePage);
        ...
        protected <DTO> DTO mapToDto(Province entity, Class<DTO> dtoClass) {
                if (dtoClass == ProvinceDetailDto.class) {
                        return dtoClass.cast(provinceDetailMapper.mapToDto(entity));
                } else if (dtoClass == ProvinceDto.class) {
