package ma.org.ormt.modules.partenaires.partenaire.controllers.admin;
...
@RestController
@RequestMapping("api/v1/admin/partenaires")
@RequiredArgsConstructor
public class PartenaireAdminLoadController extends BaseController<Partenaire> {
