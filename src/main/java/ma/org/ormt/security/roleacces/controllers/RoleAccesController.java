...
public class RoleAccesController {
    ...
    public List<Long> getAccessibleResources(
        ...
        return permissionService.getAccessibleResources(roleCode, typeRessource, niveauAcces);
    }
    ...
    public ResponseEntity<?> addAccess(
        ...
        if (applyToChildren) {
            permissionService.setHierarchicalAccess(roleCode, typeRessource, ressourceId, niveauAcces, true, username);
            return ResponseEntity.ok("Accès hiérarchique ajouté avec succès");
        } else {
            RoleAcces acces = permissionService.addAccess(roleCode, typeRessource, ressourceId, niveauAcces, username);
    ...
    public ResponseEntity<Boolean> checkAccess(
        ...
        boolean hasAccess = permissionService.hasAccess(roleCode, typeRessource, ressourceId, niveauAcces);
