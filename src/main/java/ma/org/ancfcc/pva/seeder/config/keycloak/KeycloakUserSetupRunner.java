package ma.org.ancfcc.pva.seeder.config.keycloak;
...
import ma.org.ancfcc.pva.security.keycloak.services.roles.client.KeycloakClientRoleService;
import ma.org.ancfcc.pva.security.keycloak.services.roles.enums.KeycloakRole;
import ma.org.ancfcc.pva.security.keycloak.services.users.KeycloakUserService;
...
public class KeycloakUserSetupRunner implements CommandLineRunner {
    ...
    private Map<String, String> getRolesMap() {
        return Map.of(
                KeycloakRole.ADMIN_PVA.getRoleName(), "administrateur pva",
                KeycloakRole.AGENT_PVA.getRoleName(), "agent pva",
                KeycloakRole.RESPONSABLE_PVA.getRoleName(), "responsable pva",
                KeycloakRole.RESPONSABLE_EXTERNE.getRoleName(), "responsable externe");
    }
