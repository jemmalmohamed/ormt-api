...
def parse_csv_to_json():
    # File paths
    csv_file = Path("/home/jemmal/dev/ormt/ormt/ormt-api/data/back/salaire moyen par secteur activitie.csv")
    json_file = Path("/home/jemmal/dev/ormt/ormt/ormt-api/data/init-data/domaines/demande-de-travail/sous-domaines/salaire-productivite/data/salaire moyen par secteur d'activité.json")
    ...
    json_data = {
        "indicateur": "salaire moyen par secteur d'activité",
        "data": data_entries
    }
