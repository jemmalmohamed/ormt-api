...
def parse_csv_to_json():
    # File paths
    csv_file = Path("/home/jemmal/dev/ormt/ormt/ormt-api/data/back/nombre d'entrprise sortants.csv")
    json_file = Path("/home/jemmal/dev/ormt/ormt/ormt-api/data/init-data/domaines/demande-de-travail/sous-domaines/tissu-economique/data/nombre d'entreprises sortants.json")
    ...
    json_data = {
        "indicateur": "nombre d'entreprises sortants",
        "data": data_entries
    }
